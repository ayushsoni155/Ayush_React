...
const secretKey = '@@@@1234@bytewise24'; // Keep this secure and never expose it publicly.
...
const LandingPage = () => {
  const notesArray = [
    ...
    },
    {
      ...
      Sem: '1st',
      description:
        ' It teaches the basics of technical drawing, including projections, drafting, and visualization of objects.',
      image: '/Eng_Ed.png',
      branch: 'CSE',
  ...
  useEffect(() => {
    ...
    if (encryptedCookie && encryptedCookie.status) {
      const decryptedCookie = decryptCookie(encryptedCookie);
      if (decryptedCookie) {
        const fullName = decryptedCookie.name;
