...
const Login = () => {
    ...
    if (name === "enrolmentID") {
        ...
        // Trigger vibration only once for enrolmentID
        if (!isValidEnrolment && !errors.enrolmentID && navigator.vibrate) {
    ...
    if (name === "password") {
        ...
        // Trigger vibration only once for password
        if (!isValidPassword && !errors.password && navigator.vibrate) {
            navigator.vibrate([100, 50, 100]);
        }
    }
};
